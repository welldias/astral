...
SlideDeck build_slide_deck(const std::string &document_text, const std::string &base_dir) {
    ...
    for (const SlideSource &slide_source : split_into_slides(document_text)) {
        ...
        deck.codepoints.emoji_codepoints.insert(codepoint_usage.emoji_codepoints.begin(), codepoint_usage.emoji_codepoints.end());
        deck.codepoints.asian_codepoints.insert(codepoint_usage.asian_codepoints.begin(), codepoint_usage.asian_codepoints.end());
        deck.codepoints.other_codepoints.insert(codepoint_usage.other_codepoints.begin(), codepoint_usage.other_codepoints.end());
